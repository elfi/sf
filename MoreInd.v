...
and_ind_expected:
    forall (P Q : Prop) (PP : and P Q -> Prop),
        (forall (a : P) (b : Q), PP (conj P Q a b)) ->
        forall a' : and P Q, PP a'.
*)

Check and_ind.

(* actual simplified principle generated by Coq 
and_ind:
    forall (P Q PP : Prop),
        (P -> Q -> PP) ->
        and P Q -> PP
...
or_ind_expected:
    forall (P Q : Prop) (PP : or P Q -> Prop),
        (forall a : P, PP (or_introl P Q a)) ->
        (forall b : Q, PP (or_intror P Q b)) ->
        forall a' : or P Q, PP a'.
*)
